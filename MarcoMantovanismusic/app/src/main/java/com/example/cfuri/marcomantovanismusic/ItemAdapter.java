...
class ItemAdapter extends ArrayAdapter<Item> {
     ...
     * @return convertView to render on screen, based on position.
     */
    @NonNull
    @Override
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Get the item data for this position in the list.
        final Item currentItem = getItem(position);

        // Lookup TextViews in the item.xml layout for data population
        ...
        // Populate the data into the convertView
