/*
 * MusicSheetPdfActivity is for Pdf Music Sheet files
 * (while Mp3Activity is for audio files).
 * Reference for image file: https://commons.wikimedia.org/wiki/File:Pdflogogt.png
 */
...
public class MusicSheetPdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create a music sheet item ArrayList
        final ArrayList<Item> itemArrayList = new ArrayList<>();

        //Add Strings in ArrayList, depending on category
        switch (category) {
            case R.string.category_arrangements:
                ...
                break;
            case R.string.category_compositions:
                ...
                break;
            case R.string.category_transcriptions:
                itemArrayList.add(new Item(R.string.transcriptions_padre_name, R.string.transcriptions_padre_description, R.drawable.pdf_image, R.string.transcriptions_padre_url));
                itemArrayList.add(new Item(R.string.transcriptions_fuga_name, R.string.transcriptions_fuga_description, R.drawable.pdf_image, R.string.transcriptions_fuga_url));
                itemArrayList.add(new Item(R.string.transcriptions_panis_name, R.string.transcriptions_panis_description, R.drawable.pdf_image, R.string.transcriptions_panis_url));
                itemArrayList.add(new Item(R.string.transcriptions_montanara_name, R.string.transcriptions_montanara_description, R.drawable.pdf_image, R.string.transcriptions_montanara_url));
                itemArrayList.add(new Item(R.string.transcriptions_538_name, R.string.transcriptions_538_description, R.drawable.pdf_image, R.string.transcriptions_538_url));
                itemArrayList.add(new Item(R.string.transcriptions_891_name, R.string.transcriptions_891_description, R.drawable.pdf_image, R.string.transcriptions_891_url));
                itemArrayList.add(new Item(R.string.transcriptions_883_name, R.string.transcriptions_883_description, R.drawable.pdf_image, R.string.transcriptions_883_url));
                itemArrayList.add(new Item(R.string.transcriptions_849_name, R.string.transcriptions_849_description, R.drawable.pdf_image, R.string.transcriptions_849_url));
                itemArrayList.add(new Item(R.string.transcriptions_wachet_name, R.string.transcriptions_wachet_description, R.drawable.pdf_image, R.string.transcriptions_wachet_url));
                itemArrayList.add(new Item(R.string.transcriptions_mission_name, R.string.transcriptions_mission_description, R.drawable.pdf_image, R.string.transcriptions_mission_url));
                itemArrayList.add(new Item(R.string.transcriptions_cinema_name, R.string.transcriptions_cinema_description, R.drawable.pdf_image, R.string.transcriptions_cinema_url));
                itemArrayList.add(new Item(R.string.transcriptions_lieben_name, R.string.transcriptions_lieben_description, R.drawable.pdf_image, R.string.transcriptions_lieben_url));
                itemArrayList.add(new Item(R.string.transcriptions_ricercare_name, R.string.transcriptions_ricercare_description, R.drawable.pdf_image, R.string.transcriptions_ricercare_url));
                itemArrayList.add(new Item(R.string.transcriptions_thiefer_name, R.string.transcriptions_thiefer_description, R.drawable.pdf_image, R.string.transcriptions_thiefer_url));
                itemArrayList.add(new Item(R.string.transcriptions_thron_name, R.string.transcriptions_thron_description, R.drawable.pdf_image, R.string.transcriptions_thron_url));
                itemArrayList.add(new Item(R.string.transcriptions_trost_name, R.string.transcriptions_trost_description, R.drawable.pdf_image, R.string.transcriptions_trost_url));
                break;
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
                ...
                // Start Intent
                itemDetailIntent = new Intent(getBaseContext(), MusicSheetPdfDetailActivity.class);

                // Pass variables description to MusicSheetPdfDetailActivity
                ...
                // Start MusicSheetPdfDetailActivity
